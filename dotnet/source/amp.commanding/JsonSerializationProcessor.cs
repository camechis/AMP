...
{
    public class JsonSerializationProcessor : ICommandProcessor
    {
        protected ILog _log;
        ...
        {
            if (CommandContext.Directions.In == context.Direction)
            {
        ...
        public virtual void ProcessInbound(CommandContext context, Action continueProcessing)
        {
            bool success = false;
            ...
            try
            {
                ...
                if (null != type) // if we did get a Type, we can deserialize the event
                {
                    ...
                    context.Command = JsonConvert.DeserializeObject(jsonString, type, _settings);
        ...
        public virtual void ProcessOutbound(CommandContext context, Action continueProcessing)
        {
            object ev = context.Command;
