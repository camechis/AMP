...
namespace amp.tests.integration.ConfigScenarios
{
    ...
    /// </summary>
    [TestFixture]
    [Ignore("FIXME:  Need to implement amp.utility.http.SslWebRequestFactory and set up certs for WindowsCertificateStoreCertProvider.")]
    public class GtsAnubisAndTwoWaySSLforRabbit
    {
        ...
        protected virtual string[] ConfigFiles
        {
            get
            {
                return new string[] { Config.Bus.All, Config.Authorization.AnubisTwoWaySsl, Config.Topology.Gts};
            }
        }
