...
public class BaseRouteTests {
	...
	public void setup(){
		...
		exchangeNotEquivelentModel.brokers.add(new Broker(null,"reference", 0, true));
		...
		routeNotEquivelentModel.brokers.add(new Broker(null,"reference", 0, true));
	}
