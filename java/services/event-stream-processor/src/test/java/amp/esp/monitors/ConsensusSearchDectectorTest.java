...
public class ConsensusSearchDectectorTest extends AbstractDetectorTest {
    ...
    public void testSearches() {
        ...
        WrappedEnvelope reqMS1 = TestUtils.makeSearchRequest("Maxwell Smart", "Shoe Phone with cam", "MS1");
        sendAndExpectNo(reqMS1, CONSENSUS_SEARCH_EVENT);

        WrappedEnvelope reqPW1 = TestUtils.makeSearchRequest("Peewee Herman", "sat one imagery", "PW1");
        sendAndExpectNo(reqPW1, CONSENSUS_SEARCH_EVENT);

        WrappedEnvelope reqPW2 = TestUtils.makeSearchRequest("Peewee Herman", "sat two imagery", "PW2");
        sendAndExpectNo(reqPW2, CONSENSUS_SEARCH_EVENT);

        WrappedEnvelope reqJB1 = TestUtils.makeSearchRequest("James Bond", "Dr No personnel file and cam feed", "JB1");
        sendAndExpectNo(reqJB1, CONSENSUS_SEARCH_EVENT);

        WrappedEnvelope reqJB2 = TestUtils.makeSearchRequest("James Bond", "Kill Authorization", "JB2");
        sendAndExpectNo(reqJB2, CONSENSUS_SEARCH_EVENT);

        WrappedEnvelope reqPW3 = TestUtils.makeSearchRequest("Peewee Herman", "sat three imagery", "PW3");
        ...
        WrappedEnvelope reqJB3 = TestUtils.makeSearchRequest("James Bond", "Underwater car", "JB3");
        sendAndExpectNo(reqJB3, CONSENSUS_SEARCH_EVENT);

        WrappedEnvelope reqJB4 = TestUtils.makeSearchRequest("James Bond", "sat imagery for secret island", "JB4");
        ...
        WrappedEnvelope reqCB1 = TestUtils.makeSearchRequest("Chuck Bartowski", "Buy More cam", "CB1");
