...
@Path("/definitions/producing-route")
@Produces(MediaType.APPLICATION_JSON)
public class ProducingRouteDefinitionResource {

	private static final Logger logger = 
			LoggerFactory.getLogger(ProducingRouteDefinitionResource.class);
	
	DefinitionRepository<ProducingRouteDefinition> repository;
	
	public ProducingRouteDefinitionResource(
			DefinitionRepository<ProducingRouteDefinition> repository){
	...
	@GET
    @Timed
	public Collection<ProducingRouteDefinition> getAll() {
	...
	@Path("/{id}")
    @Timed
	public ProducingRouteDefinition get(@PathParam("id") String id) {
	...
	@Path("/{id}")
    @Timed
	public Response create(@PathParam("id") String id, ProducingRouteDefinition definition) {
	...
	@Path("/{id}")
    @Timed
	public Response update(@PathParam("id") String id, ProducingRouteDefinition definition) {
